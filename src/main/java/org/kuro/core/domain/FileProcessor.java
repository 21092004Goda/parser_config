...
public class FileProcessor {
    public static List<List<String>> readFiles(List<String> paths) {
    ...
    public static Map<Integer, List<String>> processFiles(List<List<String>> fileContents, ActionType actionType) {
        try {
